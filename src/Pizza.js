...
import im from "./Images/Background/im.jpg";
import './App.css';
...
<>
            ...
            <div className="row g-0 ">
                ...
                <img src={im}  className=" bg d-block w-100 "  />
                </div>
                </div>
...
<div  className='mt-5 '>
  <div className='container '>
    <button type="button" onClick={getDataFromAPI}  className="btn btn-primary mt-5">Pizzas</button>
...
{/*     
    <img className='w-100 h-50 mt-5 mb-3' src={dt.thumbnail}/>
    <h1 className='fs-4'>title:{dt.title}</h1> */}
